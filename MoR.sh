...
#SBATCH --job-name=MoR     # The job name.
...
R CMD BATCH --no-save --vanilla MoR.R /burg/home/yt2661/projects/Fed-Grad-EM/experiments/MoR/out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt
